...
def train(sim_state):
    ...
    space = {
        "gamma": hp.choice("gamma", [0.95, 0.99]),
        "num_sgd_iter": hp.choice("num_sgd_iter", [10, 20, 30]),
        "sgd_minibatch_size": hp.choice("sgd_minibatch_size", [32, 64, 256, 1024]),
        "train_batch_size": hp.choice("train_batch_size", [2048, 4096]),
        "lr": hp.choice("lr", [0.003, 0.0001, 0.000005]),
        "clip_param": hp.choice("clip_param", [0.1, 0.2, 0.3]),
        "kl_coeff": hp.choice("kl_coeff", [0.3, 0.65, 1]),
        "kl_target": hp.choice("kl_target", [0.003, 0.01, 0.03]),
        "lambda": hp.choice("lambda", [0.9, 0.95, 1.0]),
        "entropy_coeff": hp.choice("entropy_coeff", [0, 0.01])
    }
