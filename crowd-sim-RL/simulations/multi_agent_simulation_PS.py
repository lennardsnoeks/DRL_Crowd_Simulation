...
def main():
    ...
    filename = os.path.join(dirname, "../test_XML_files/training/4-hallway/1.xml")
    seed = 1
    ...
    checkpoint_path = "/home/lennard/ray_results/test_apex/APEX_DDPG_multi_agent_env_32bb141a_0_2020-04-09_18-14-32ft7mtt98/checkpoint_8/checkpoint-8"
